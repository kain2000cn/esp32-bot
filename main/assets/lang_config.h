...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char p3_bashi_start[] asm("_binary_bashi_p3_start");
        extern const char p3_bashi_end[] asm("_binary_bashi_p3_end");
        static const std::string_view P3_BASHI {
        static_cast<const char*>(p3_bashi_start),
        static_cast<size_t>(p3_bashi_end - p3_bashi_start)
        };

        extern const char p3_biemole_start[] asm("_binary_biemole_p3_start");
        extern const char p3_biemole_end[] asm("_binary_biemole_p3_end");
        static const std::string_view P3_BIEMOLE {
        static_cast<const char*>(p3_biemole_start),
        static_cast<size_t>(p3_biemole_end - p3_biemole_start)
        };
